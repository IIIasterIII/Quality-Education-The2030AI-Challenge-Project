...
import { COLORS, NoteNode } from "@/app/app/nodes/types"

interface CreateNodesModalProps {
    isOpen: boolean;
    onOpenChange: (open: boolean) => void;
    onConfirm: (newNode: NoteNode) => void;
}

export const CreateNodesModal = ({ isOpen, onOpenChange, onConfirm }: CreateNodesModalProps) => {
